...
class Lexicon:    
    def __init__(self):
        self.start = "Привет. Это бот для учета финансов. Ты можешь вести журнал доходов и расходов," \
